 ...
 *
 * $this->appendSet( $editorParam, $value, $separator ) allows to append string to existing setting
 *
...
$this->set('toolbar',     '[
                ...
                "/",
                { name: "misc2",    items: [ "SpecialChar", "Superscript", "Subscript" ]},
                { name: "maximize", items: [ "Maximize" ]},
                { name: "about",    items: [ "About" ]}
            ]', 'json' );

$this->appendSet('extraPlugins', 'xml', ',');   //
